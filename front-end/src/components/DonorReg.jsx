      ...
      <div className='flex justify-center h-[100vh] items-center '>
            <div className='bg-green-100 w-[45rem] rounded-3xl h-[75vh] border-solid border-2 border-green-300 flex flex-col items-center p-4'>
                ...
                <div className=' p-[7rem] pb-5 pt-5 text-lg text-slate-400'>
                    ...
                    <input:Number className='bg-white h-[3.5rem] w-[28rem] rounded-full flex justify-center items-center  '>+9 9337527307</input:Number>
                    <br />
                    <br /><br />
                    ...
                    <button className='border-solid border-2 border-black w-[11rem] rounded-lg h-[3.5rem] text-xl font-semibold hover:bg-green-200 hover:text-white'>Connect Anom Adhaar</button>
